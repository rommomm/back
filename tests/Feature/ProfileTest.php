...
class ProfileTest extends TestCase
{
    ...
    public function test_user_can_edit_first_name()
    {
        ...
        ->assertOk();
        $this->assertDatabaseHas('profiles', ['id' => $this->profile->id, 'first_name' => 'My first_name']);
    }
    ...
    public function test_user_can_edit_last_name()
    {
        ...
        ->assertOk();
        $this->assertDatabaseHas('profiles', ['id' => $this->profile->id, 'last_name' => 'My last_name']);
    }
    ...
    public function test_user_can_remove_avatar()
    {
        ...
        $this->assertDatabaseHas('profiles', ['id' => $this->profile->id, 'profile_avatar' => null]);
    }
    ...
    public function test_user_can_remove_background()
    {
        ...
        $this->assertDatabaseHas('profiles', ['id' => $this->profile->id, 'profile_background' => null]);
    }
